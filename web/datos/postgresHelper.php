...
class PostgreSQL
{
	...
	public function num_rows($consulta){
  	...
  	public function auditoria($tbl,$t,$usr,$data,$obs){
  		$sql = "INSERT INTO admin.auditoria(tabla,tipo,usuario,dato,obser)
    			VALUES ('".$tbl."','".$t."','".$usr."','".$data."','".$obs."');";
  		$q = $this->consulta($sql);
  		$this->affected_rows($q);
  		$this->close($q);
  	}
}
