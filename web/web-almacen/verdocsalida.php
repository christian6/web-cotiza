	...
	if (isset($_POST['btnsearch'])) {
		...
		if ($cn->num_rows($query) > 0) {
			while ($result = $cn->ExecuteNomQuery($query)) {
				...
				if ($_POST['btnrd'] == "g") {
				?>
					<td style='text-align: center;'><a href="javascript:window.open('http://190.41.246.91/web/reports/almacen/pdf/rptguiaremision.php?nro=<?php echo $result['nrodoc']?>');"><i class='icon-align-justify'></i></a></td>
					<td style='text-align: center;'><a href="javascript:window.open('http://190.41.246.91/web/reports/almacen/pdf/rptguiaremisionsin.php?nro=<?php echo $result['nrodoc']?>');"><i class='icon-align-left'></i></a></td>
					<td style="text-align: center;"><a href="javascript:anular('g','<?php echo $result['nrodoc']?>');"><i class="icon-remove-circle"></i></a></td>
				<?php
				}elseif($_POST['btnrd'] == "n") {
				?>
					<td style='text-align: center;'><a href="javascript:window.open('http://190.41.246.91/web/reports/almacen/pdf/rptnotasalida.php?nro=<?php echo $result['nrodoc']?>');"><i class='icon-align-justify'></i></a></td>
					<td style='text-align: center;'><a href="javascript:window.open('http://190.41.246.91/web/reports/almacen/pdf/rptnotasalidasin.php?nro=<?php echo $result['nrodoc']?>');"><i class='icon-align-left'></i></a></td>
